...
public class SampleCallLog extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                if (ActivityCompat.checkSelfPermission(SampleCallLog.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (!ActivityCompat.shouldShowRequestPermissionRationale(SampleCallLog.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_CALL_PHONE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(SampleCallLog.this, "CALL_PHONE Denied", Toast.LENGTH_SHORT)
                            .show();
