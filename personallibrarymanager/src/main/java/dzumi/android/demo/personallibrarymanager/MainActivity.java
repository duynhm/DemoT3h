package dzumi.android.demo.personallibrarymanager;
...
import dzumi.android.demo.personallibrarymanager.dao.BookDAO;
                ...
                if(!json.isEmpty()){
                    ...
                    try {
                        ...
                        for(int i = 0; i < data.length(); i++){
                            ...
                            genres.setGenresID(child.getInt("genresID"));
                            genres.setGenresName(child.getString("genresName"));

                            Type listType = new TypeToken<ArrayList<Book>>(){}.getType();
                            books = new GsonBuilder().create().fromJson(child.getJSONArray("books").toString(), listType);

                            //insert db
                            BookDAO bookDAO = new BookDAO(MainActivity.this);
                            bookDAO.insert(genres, books);
